                ...
                @else
                  @foreach ($history_pembayaran as $item)
                    <tr class="text-center {{$item->status == 'Batal' ? 'bg-light' : ''}}">
                      ...
                      <td>
                        <a href="{{route('print', ['id' => $item->id, 'type' => 'invoice'])}}" class="btn btn-sm btn-outline-primary {{$item->status === 'Batal' ? 'disabled' : ''}}"><i class="fas fa-print"></i> Invoice</a>
                        <a href="{{route('print', ['id' => $item->id, 'type' => 'kwitansi'])}}" class="btn btn-sm btn-outline-primary {{$item->status === 'Batal' ? 'disabled' : ''}}"><i class="fas fa-print"></i> Kwitansi</a> 
                      </td>
                    </tr>
                  @endforeach
                @endif
