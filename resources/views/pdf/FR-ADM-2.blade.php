...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><font face="Helvetica" color="#000000">{{$item->std != NULL ? '*' : ''}}</font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="center" valign=middle><font face="Helvetica" color="#000000">{{Dit::Rupiah($item->harga_satuan)}}</font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle sdval="1" sdnum="1033;"><font face="Helvetica" color="#000000">{{$item->alt}}</font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 2px solid #000000" colspan=2 align="center" valign=middle><font face="Helvetica" color="#000000">{{Dit::Rupiah($item->harga_satuan * $item->alt)}}</font></td>
    </tr>
    @endforeach
